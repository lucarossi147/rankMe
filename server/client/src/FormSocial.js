...
const FacebookButton = (props) => {
    if(props.facebook === null){
        errorNotify("This user didn't set his social")
    }
    const link = "https://" + props.facebook
    return (
        <button onClick={()=> window.open(link, "_blank")} type="button" className="btn btn-primary social">
    ...
    /*
    TODO mettere link a facebook e insta (props.facebook)
     */
}
...
const InstagramButton = (props) => {
    ...
    const link = "https://" + props.instagram

    return (
        <button onClick={()=> window.open(link, "_blank")} type="button" className="btn btn-outline-danger social">
            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="35" fill="currentColor"
